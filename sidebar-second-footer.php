...
$footer_col = '3_3_3_3';
if( !empty($fixology_theme_options['second_footer_column_layout']) ){
	$footer_col = esc_attr($fixology_theme_options['second_footer_column_layout']);
}
?>
...
<div id="second-footer" class="sidebar-container second-footer<?php echo thememount_sanitize_html_classes(thememount_footer_row_class( 'second' )); ?>" role="complementary">
				...
				<?php } else {
					...
					if( is_array($footer_col) && count($footer_col)>0 ){
						...
						if ( is_active_sidebar( 'second-footer-'.$x.'-widget-area' ) ) : ?>
							<div class="widget-area <?php echo thememount_sanitize_html_classes($row_class); ?> second-widget-area">
