 ...
 *
 */
class CSFramework_Option_thememount_dimensions extends CSFramework_Options {
  ...
  public function output(){
	...
	echo '<input placeholder="'. esc_html__('Width', 'fixology') .'" type="'. $this->element_type() .'" name="'. $this->element_name( '[width]' ) .'" value="'. $value_width .'"'. $this->element_class('mini') . $this->element_attributes() .'/>';
	...
	echo '<input placeholder="'. esc_html__('Height', 'fixology') .'" type="'. $this->element_type() .'" name="'. $this->element_name( '[height]' ) .'" value="'. $value_height .'"'. $this->element_class('mini') . $this->element_attributes() .'/>';
	echo '<span class="add-on add-on-right"> px</span>';
	echo '</div>';
	...
	echo '
		<strong>' . esc_html__( 'Hard Crop Image?', 'fixology' ) . '</strong>
		 &nbsp; 
		<label class="radio inline">
		
			<input type="radio" name="'. $this->element_name( '[crop]' ) .'" value="yes"'. $this->element_attributes() . ' '.$value_crop_yes.' />
		
			'.esc_html__('YES','fixology').'
		</label>
		 &nbsp; 
		<label class="radio inline">
		
			<input type="radio" name="'. $this->element_name( '[crop]' ) .'" value="no"'. $this->element_attributes() . ' '.$value_crop_no.'/>
