 ...
 *
 */
class CSFramework_Option_thememount_wpml extends CSFramework_Options {
  ...
  public function output(){
	...
	$config['box_title']		= esc_html__( 'Multilingual Fixology Theme', 'fixology' );
	$config['name']				= esc_html( 'Fixology' ); //name of theme/plugin
	$config['box_description']	= esc_html__('Fixology theme is fully compatible with WPML - the WordPress Multilingual plugin. WPML lets you add languages to your existing sites and includes advanced translation management.', 'fixology' );
