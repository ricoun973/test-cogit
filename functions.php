<?php
/**
 * Fixology functions and definitions
 *
...
if ( ! function_exists( 'fixology_setup' ) ) :
/**
...
function fixology_setup() {
	 ...
	 * If you're building a theme based on fixology, use a find and replace
	 * to change 'fixology' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'fixology', get_template_directory() . '/languages' );
	...
	register_nav_menus( array( // https://codex.wordpress.org/Function_Reference/has_nav_menu
		'tm-main-menu'			=> esc_html__( 'Main Menu', 'fixology' ),
		'tm-footer-menu'		=> esc_html__( 'Footer Menu', 'fixology' ),
		'tm-topbar-left-menu'	=> esc_html__( 'Topbar Left Menu', 'fixology' ),
		'tm-topbar-right-menu'	=> esc_html__( 'Topbar Right Menu', 'fixology' ),
	) );
	
}
endif; // fixology_setup()
add_action( 'after_setup_theme', 'fixology_setup' );
