...
$footer_col = '3_3_3_3';
if( !empty($fixology_theme_options['first_footer_column_layout']) ){
	$footer_col = esc_attr($fixology_theme_options['first_footer_column_layout']);
}
?>
...
<div id="first-footer" class="sidebar-container first-footer <?php echo thememount_sanitize_html_classes(thememount_footer_row_class( 'first' )); ?>" role="complementary">
