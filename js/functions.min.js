jQuery('#totop').hide();jQuery(window).scroll(function(){"use strict";if(jQuery(this).scrollTop()>=100){jQuery('#totop').fadeIn(200);jQuery('#totop').addClass('top-visible')}else{jQuery('#totop').fadeOut(200);jQuery('#totop').removeClass('top-visible')}});jQuery('#totop').on('click',function(){jQuery('body,html').animate({scrollTop:0},500);return!1});equalheight=function(container){var currentTallest=0,currentRowStart=0,rowDivs=new Array(),$el,topPosition=0;jQuery(container).each(function(){$el=jQuery(this);jQuery($el).outerHeight('auto')
...
filterLinks.on('click',function(e){var selector=jQuery(this).attr('data-filter');gallery_item.isotope({filter:selector,itemSelector:'.isotope-item'});filterLinks.removeClass('selected');jQuery('#filter-by li').removeClass('current-cat');jQuery(this).addClass('selected');e.preventDefault()})})};function fixology_logMarginPadding(){jQuery('.wpb_column').each(function(){if(jQuery(this).hasClass('tm-left-span')){var margin=jQuery(this).parent().css("padding-left").replace("px","");margin=parseInt(margin);var elewidth=jQuery(this).css("width").replace("px","");elewidth=parseInt(elewidth);var leftmargin=margin+elewidth;var after_inlinecss='';var before_inlinecss='';var randomclass=Math.floor((Math.random()*1000000)+1);randomclass='fixology-random-class-'+randomclass;jQuery(this).addClass(randomclass);after_inlinecss+='padding-left: '+leftmargin+'px;';if(jQuery('.vc_column-inner',this).css('background-image')!='none'){var bgimage=jQuery('.vc_column-inner',this).css('background-image');jQuery('.vc_column-inner',this).css('background-image','none','!important');after_inlinecss+='background-image: '+bgimage+';'}
...
function fixology_logMarginPadding_right(){jQuery('.wpb_column').each(function(){if(jQuery(this).hasClass('tm-right-span')){var margin=jQuery(this).parent().css("padding-right").replace("px","");margin=parseInt(margin);var elewidth=jQuery(this).css("width").replace("px","");elewidth=parseInt(elewidth);var leftmargin=margin+elewidth;var after_inlinecss='';var before_inlinecss='';var randomclass=Math.floor((Math.random()*1000000)+1);randomclass='fixology-random-class-'+randomclass;jQuery(this).addClass(randomclass);after_inlinecss+='padding-right: '+leftmargin+'px;';if(jQuery('.vc_column-inner',this).css('background-image')!='none'){var bgimage=jQuery('.vc_column-inner',this).css('background-image');jQuery('.vc_column-inner',this).css('background-image','none','!important');after_inlinecss+='background-image: '+bgimage+';'}
if(jQuery('.vc_column-inner',this).css('background-color')!=''||jQuery('.vc_column-inner',this).css('background-color')!='inherit'){var bgcolor=jQuery('.vc_column-inner',this).css('background-color');before_inlinecss+='background-color: '+bgcolor+';'}
...
$('#site-navigation a[href="#"]').on('click',function(){return!1});$(".thememount-close-icon").on('click',function(){$("#page").css('padding-top',(parseInt($("#page").css('padding-top'))-parseInt($(".thememount-wbar").height()))+'px');$(".thememount-wbar").slideUp();thememount_setCookie('kw_hidewbar','1',1)});var galleryHTML=jQuery(".gallery-size-full br").each(function(){jQuery(this).remove()});jQuery("a.thememount-open-gallery").on('click',function(){var href=jQuery(this).attr('href');var id=href.replace("#thememount-embed-code-","");var currid=window['api_images_'+id];jQuery.prettyPhoto.open(window['api_images_'+id],window['api_titles_'+id],window['api_desc_'+id])});if(jQuery().isotope){jQuery(window).load(function(){"use strict";thememount_isotope()});jQuery(window).resize(function(){"use strict";thememount_isotope()});jQuery('.vc_tta-tab > a').on('click',function(){var vc_tta=jQuery(this).closest('.vc_tta');jQuery(vc_tta).find(".tm-flexslider").each(function(){jQuery(this).resize(function(){thememount_isotope()})})})}
